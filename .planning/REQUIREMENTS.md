...
- [x] **POLICY-04**: 서비스는 생성 결과를 재생 전에 태그, 타임스탬프 범위, 언어 정책, 원음 대사 내용 중복, 문장 길이, 근거, TTS 적격성 기준으로 검증한다. 유튜브처럼 음성이 계속 이어지는 영상의 시각 설명은 원음과 시간상 겹칠 수 있다.
...
- [ ] **PLAY-04**: TTS는 이벤트 타임스탬프에 따라 재생하며, 시각 설명이 계속되는 원음과 시간상 겹칠 수 있음을 전제로 한다. 한국어 원음 대사의 내용을 중복 낭독하지 않고, 외국어 번역은 확인된 외국어 구간에만 제공한다.
